        ...
        <div class="form-group">
            ...
            @if (Gate::allows('contact_create'))
                @if ('button' === $addnew_type)
                    &nbsp;<button type="button" class="btn btn-danger modalForm" data-id="0"
                        data-selectedid="client_id" data-action="createclient"
                        data-redirect="{{ route('admin.client_projects.create') }}" data-toggle="tooltip"
                        data-placement="bottom"
                        data-original-title="{{ trans('global.add_new_title', ['title' => strtolower(trans('global.client-projects.fields.client'))]) }}">{{ trans('global.app_add_new') }}</button>
                @else
                    &nbsp;<a class="modalForm" data-action="createclient" data-selectedid="client_id"
                        data-toggle="tooltip" data-placement="bottom"
                        data-original-title="{{ trans('global.add_new_title', ['title' => strtolower(trans('global.client-projects.fields.client'))]) }}"><i
...
<div class="row">
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            ...
            {!! Form::select('priority', $enum_priority, old('priority'), [
                'class' => 'form-control select2',
                'required' => '',
            ]) !!}
            <p class="help-block"></p>
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            {!! Form::label('billing_type_id', trans('global.client-projects.fields.billing-type') . '*', [
                'class' => 'control-label',
            ]) !!}
            <?php
            $disable = '';
            ...
            if (!empty($client_project)) {
                $billed_tasks = \App\ProjectTask::where('project_id', $client_project->id)
                    ->where('billable', 'yes')
                    ->where('billed', 'yes')
                    ->first();
                $billed_expenses = \App\Expense::where('project_id', $client_project->id)
                    ->where('billable', 'yes')
                    ->where('billed', 'yes')
                    ->first();
            ...
            ?>
            {!! Form::select('billing_type_id', $billing_types, old('billing_type_id'), [
                'class' => 'form-control select2',
                'required' => '',
                'id' => 'billing_type_id',
                $disable,
    ...
    <div class="col-xs-{{ COLUMNS }}" id="budget_div" style="{{ $budget_div }}">
        <div class="form-group">
            {!! Form::label('budget', trans('global.client-projects.fields.budget') . ' ' . getDefaultCurrency(), [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                {!! Form::number('budget', old('budget'), [
                    'class' => 'form-control',
                    'min' => '0',
                    'step' => '.01',
                    'placeholder' => trans('global.client-projects.fields.budget') . ' ' . getDefaultCurrency(),
                ]) !!}
                <p class="help-block"></p>
    ...
    <div class="col-xs-{{ COLUMNS }}" id="hourly_rate_div" style="{{ $hourly_rate_div }}">
        <div class="form-group">
            {!! Form::label('hourly_rate', trans('global.client-projects.fields.hourly_rate') . ' ' . getDefaultCurrency(), [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                {!! Form::number('hourly_rate', old('hourly_rate'), [
                    'class' => 'form-control',
                    'min' => '0',
                    'step' => '.01',
                    'placeholder' => trans('global.client-projects.fields.hourly_rate') . ' ' . getDefaultCurrency(),
                ]) !!}
                <p class="help-block"></p>
    ...
    <div class="col-xs-{{ COLUMNS }}" id="project_rate_per_hour_div" style="{{ $project_rate_per_hour_div }}">
        <div class="form-group">
            {!! Form::label(
                ...
                trans('global.client-projects.fields.project_rate_per_hour') . ' ' . getDefaultCurrency(),
                ['class' => 'control-label form-label'],
            ) !!}
            <div class="form-line">
                {!! Form::number('project_rate_per_hour', old('project_rate_per_hour'), [
                    'class' => 'form-control',
                    'min' => '0',
                    'step' => '.01',
                    'placeholder' => trans('global.client-projects.fields.project_rate_per_hour') . ' ' . getDefaultCurrency(),
                ]) !!}
                <p class="help-block"></p>
    ...
    <div class="col-xs-{{ COLUMNS }}" id="estimated_hours">
        <div class="form-group">
            {!! Form::label('estimated_hours', trans('global.client-projects.fields.estimated_hours') . '', [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                {!! Form::number('estimated_hours', old('estimated_hours'), [
...
<div class="row">
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            {!! Form::label('phase', trans('global.client-projects.fields.phase') . '', [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                {!! Form::number('phase', old('phase'), [
                    'class' => 'form-control amount',
                    'min' => '0',
                    'step' => '.01',
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            {!! Form::label('progress_from_tasks', trans('global.client-projects.fields.progress_from_tasks') . '*', [
                'class' => 'control-label',
            ]) !!}
            {!! Form::select('progress_from_tasks', yesnooptions(), old('progress_from_tasks'), [
                'class' => 'form-control select2',
                'required' => '',
            ]) !!}
            <p class="help-block"></p>
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            ...
            {!! Form::label('start_date', trans('global.client-projects.fields.start-date') . '', [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                <?php
    ...
    <div class="col-xs-{{ COLUMNS }}">
        <div class="form-group">
            ...
            {!! Form::label('due_date', trans('global.client-projects.fields.due-date') . '', [
                'class' => 'control-label form-label',
            ]) !!}
            <div class="form-line">
                <?php
...
<div class="row">
    <div class="col-xs-6">
        <div class="form-group">
            {!! Form::label('assigned_to', trans('global.client-projects.fields.assigned-to') . '', [
                'class' => 'control-label',
            ]) !!}
            ...
            ?>
            {!! Form::select('assigned_to[]', $assigned_tos, old('assigned_to'), [
                'class' => 'form-control select2',
                'multiple' => 'multiple',
                'id' => 'selectall-assigned_to',
            ]) !!}
            <p class="help-block"></p>
...
<div class="row">
    <div class="col-xs-12">
        <div class="form-group">
            {!! Form::label('description', trans('global.client-projects.fields.description') . '', [
                'class' => 'control-label',
            ]) !!}
