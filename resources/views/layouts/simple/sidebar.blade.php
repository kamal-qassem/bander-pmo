...
<div class="sidebar-wrapper">
    ...
    ?>
    <div>
        <div class="logo-wrapper"   style="vertical-align:middle; margin:0 auto;"  >
            <a href="">
                <img class="img-fluid for-light" width="80px" height="90px"
                    src="{{ asset('/uploads/settings/') . '/' . $site_logo }}" alt="">
                <img class="img-fluid for-dark" width="80px" height="90px"
                    src="{{ asset('/uploads/settings/') . '/' . $site_logo }}" alt="">
            </a>
        ...
        <div class="logo-icon-wrapper">
            <a href="#">
                <img class="img-fluid" src="{{ asset('/uploads/settings/' . $site_logo) }}" alt="">
            </a>
        </div>
        ...
        <div style=" clear:both;">
            <nav class="sidebar-main">
                ...
                <div id="sidebar-menu">
                            ...
                            @can('project_access')
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title {{ request()->route()->getPrefix() == '/ecommerce'? 'active': '' }}"
                                        href="#">
                                        <i class="fa  fa-cubes"
                                            style="padding-right:12px"></i><span>@lang('global.projects.title')</span>
                                    ...
                                    <ul class="sidebar-submenu"
                                        ...
                                        @if (isPluginActive('faq'))
                                            ...
                                            @can('faq_category_access')
                                                <li
                                                    class="{{ $request->segment(2) == 'faq_categories' ? 'active' : '' }}">
                    ...
                    <div class="according-menu"><i class="fa fa-angle-{{ request()->route()->getPrefix() == '/ecommerce'? 'down': 'right' }}"></i>
                    </div>
                    </a>
                    <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/ecommerce'? 'block': 'none;' }};">
                        <li><a href="" class="{{ Route::currentRouteName() == 'product' ? 'active' : '' }}">Product</a>
                        </li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'product-page' ? 'active' : '' }}">Product
                                page</a></li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'list-products' ? 'active' : '' }}">Product
                                list</a></li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'payment-details' ? 'active' : '' }}">Payment
                                Details</a></li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'order-history' ? 'active' : '' }}">Order
                                History</a></li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'invoice-template' ? 'active' : '' }}">Invoice</a>
                        </li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'cart' ? 'active' : '' }}">Cart</a>
                        </li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'list-wish' ? 'active' : '' }}">Wishlist</a>
                        </li>
                        <li><a href=" " class="{{ Route::currentRouteName() == 'checkout' ? 'active' : '' }}">Checkout</a>
                        </li>
                        <li><a href="" class="{{ Route::currentRouteName() == 'pricing' ? 'active' : '' }}">Pricing</a>
                        </li>
                    </ul>
                    </li> --}}
